...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"config": "not json", "valid": False},
    ],
)
def test_containers(cli, data):
    ...
    create_cmd = cli('containers', 'create', config_name, config_filename)
    list_cmd = cli('containers', 'list')
